...
if __name__ == '__main__':
    global_topic_url = "https://news.google.com/topics/CAAqKggKIiRDQkFTRlFvSUwyMHZNRFZxYUdjU0JXVnVMVWRDR2dKVFJ5Z0FQAQ?hl=en-SG&gl=SG&ceid=SG%3Aen"
    ...
    if not os.path.exists(stories_urls_fp):
        new_stories_urls = visit_google_news_topic(global_topic_url)
        stories_urls = {}
